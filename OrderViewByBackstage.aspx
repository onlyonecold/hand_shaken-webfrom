<%@ Page Title="" Language="C#" MasterPageFile="~/HandServer.Master" AutoEventWireup="true" CodeBehind="OrderViewByBackstage.aspx.cs" Inherits="hand_shaken_webform.OrderViewByBackstage" %>
                ...
                <asp:GridView ID="Order_Item_Grid" runat="server" BackColor="white"
                    ...
                    <Columns>
                        ...
                        <asp:TemplateField HeaderText="功能" HeaderStyle-Width="30%" ItemStyle-Width="10%" HeaderStyle-Font-Bold='false' HeaderStyle-BackColor="darkkhaki" HeaderStyle-Font-Size="15pt" HeaderStyle-CssClass="text-center" HeaderStyle-ForeColor="white">
                            ...
                            <ItemStyle HorizontalAlign='Center' VerticalAlign='Middle' BackColor="white" />
                            <ItemTemplate>
                                <asp:Button ID="pick_up" Text="接單" runat="server" CssClass="btn btn-success btn-sm" CommandArgument='<%# Eval("order_id") %>' OnCommand="Pick_Up_Order"/>
                                <asp:Button ID="complete" Text="製作完成" runat="server" CssClass="btn btn-success btn-sm" CommandArgument='<%# Eval("order_id") %>' OnCommand="Complete_Order"/>
