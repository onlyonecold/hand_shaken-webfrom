    ...
    <div class="row" style="margin-top: 5px;">
        ...
        <div class="col-lg-6 breadcrumb">
            ...
            <div class="form-group">
                ...
                <asp:Button CssClass="btn btn-info" runat="server" type="button" PostBackUrl="AddOrder" Text="返回" />
            </div>
                ...
                <div style="overflow: auto; height: 490px">
                    ...
                    <asp:GridView ID="Order_Item_Detail_Grid" runat="server" BackColor="white"
                        ...
                        <Columns>
                            ...
                            <asp:TemplateField HeaderText="單價" HeaderStyle-Width="10%" ItemStyle-Width="15%" HeaderStyle-Font-Bold='false' HeaderStyle-BackColor="darkkhaki" HeaderStyle-Font-Size="15pt" HeaderStyle-CssClass="text-center" HeaderStyle-ForeColor="white">
                                <HeaderStyle Font-Bold="True" />
                                <ItemStyle HorizontalAlign='Center' VerticalAlign='Middle' BackColor="white" />
                                <ItemTemplate>
                                    <asp:Label ID="status" Text='<%# Eval("price") %>' runat="server" />
                                </ItemTemplate>
                            </asp:TemplateField>
